...
SERIES_MAP: dict[str, tuple[str, str, str]] = {
    ...
    # Commodities sheet
    "Copper (USD/lb)":                      ("copper_lb",   "commodities",     "USD"),
    "Corn (USD/bushel)":                    ("corn",        "commodities",     "USD"),
    "Wheat (USD/bushel)":                   ("wheat",       "commodities",     "USD"),
    "Soybeans (USD/bushel)":                ("soybeans",    "commodities",     "USD"),
    "Sugar (USD/lb)":                       ("sugar",       "commodities",     "USD"),
    "Coffee Arabica (USD/lb)":              ("coffee",      "commodities",     "USD"),
    "Cotton (USD/lb)":                      ("cotton",      "commodities",     "USD"),
    # Energy sheet
